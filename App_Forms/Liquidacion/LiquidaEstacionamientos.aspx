<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="LiquidaEstacionamientos.aspx.vb" Inherits="WebTCMAdmin.LiquidaEstacionamientos" %>
             ...
             <tr>                    
                   <td colspan="4" class="ColumnTexto">
                        ...
                        <tr>
                            ...
                            <td class="ColumnLabels"><div class="lbl">Número de Cajones:</div></td>
                            <td class="ColumnLabels">
                                    <asp:TextBox ID="TxtNumCajones" runat="server" BorderStyle="None" ReadOnly="True" Width="41px"></asp:TextBox>                                    
                            </td>
                        </tr>
                        </table>
                   </td>
       ...
       <table class="BarraPago">
             <tr>
                            <td Class="btn btn-small btn-primary glyphicon glyphicon-print" >                                 
                                <asp:LinkButton ID="btnimprime" runat="server"  BackColor="Transparent" ForeColor="White" PostBackUrl="~/Reports/Report.aspx?Nombre=Reportes/rpliquidaEstacionamientos.rdlc" OnClientClick="window.document.forms[0].target='_blank'" Height="100%" Width="100%">Imprimir</asp:LinkButton>
                             </td>           
                            <td>&nbsp;</td>
