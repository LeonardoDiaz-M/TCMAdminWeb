<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="LiquidaOtrosDerechosDesUrbano.aspx.vb" Inherits="WebTCMAdmin.LiquidaOtrosDerechosDesUrbano" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">    
                           ...
                           <tr>
                               ...
                               <td class="ColumnLabels" colspan="2">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                                            ...
                                            SetFocusOnError="True" InitialValue="0" CssClass="alert-danger"></asp:RequiredFieldValidator>
                               </td>                               
                           </tr>
                       </table>
                   </td>
        ...
        <table class="BarraPago">
             <tr>
                            <td Class="btn btn-small btn-primary glyphicon glyphicon-print" >                                 
                                <asp:LinkButton ID="btnimprime" runat="server"  BackColor="Transparent" ForeColor="White" PostBackUrl="~/Reports/Report.aspx?Nombre=Reportes/rpliquidaDerechos.rdlc" OnClientClick="window.document.forms[0].target='_blank'">Imprimir</asp:LinkButton>
                             </td>           
                            <td>&nbsp;</td>
    ...
    <asp:SqlDataSource ID="DsDerechos" runat="server" ConnectionString="<%$ ConnectionStrings:SQLDB %>" 
        SelectCommand="SELECT Derecho_Id, descripcion FROM tbl_derechos WHERE (cve_cuenta = @Param1) AND (ejfiscal = CAST(YEAR(GETDATE()) AS CHAR(4))) ORDER BY descripcion">
        <SelectParameters>
