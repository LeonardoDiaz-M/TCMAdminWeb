<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="LiquidaLicencias.aspx.vb" Inherits="WebTCMAdmin.LiquidaLicencias" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <div class="Titulo">LICENCIAS PARA LA VENTA DE BEBIDAS ALCOHÓLICAS Y DE COMERCIO</div>    
    <hr />
             ...
             <tr>                    
                   <td colspan="4" class="ColumnTexto">
                        ...
                        <tr>
                            ...
                            <td class="ColumnLblLarge"  ><div class="lbl">Trámite que paga:</div></td>
                            <td class="ColumnTexto">
                              <asp:RadioButtonList ID="rbTipoTramite" runat="server" Font-Bold="False" class="ColumnTexto"
                                        RepeatDirection="Horizontal" Width="184px" CellPadding="0" CellSpacing="0" 
                                        Enabled="False">
                                        <asp:ListItem Selected="True" Value="1">Refrendo</asp:ListItem>
