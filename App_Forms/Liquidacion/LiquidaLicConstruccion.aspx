<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="LiquidaLicConstruccion.aspx.vb" Inherits="WebTCMAdmin.LiquidaLicConstruccion" %>
          ...
          <table class="tablarequerimientos">            
            ...
            <tr>
                ...
                <td style="text-align: left; width: 114px;">                    
                    <ig:WebMaskEditor ID="txtCveCta" runat="server" InputMask="LC-999999" Width="120px" BackColor="White" Font-Names="Arial Narrow" Font-Size="Small">
                    </ig:WebMaskEditor>
                </td>
                <td style="text-align: left">
                    &nbsp;</td>
                <td style="text-align: left">
                    <asp:Label ID="lblDias0" runat="server" Font-Bold="True" Text="Tipo de Trámite:"></asp:Label>
                    <asp:RadioButtonList ID="rbTipoTramite" runat="server" AutoPostBack="True" RepeatDirection="Horizontal">
                        <asp:ListItem Selected="True" Value="1">Expedición</asp:ListItem>
                        <asp:ListItem Value="2">Prórroga</asp:ListItem>
                    </asp:RadioButtonList>
                </td>
                <td style="text-align: left">
                    <asp:Label ID="lblMeses" runat="server" Font-Bold="True" Text="Núm. de Meses:" Visible="False"></asp:Label>
                    <asp:TextBox ID="TxtNumMeses" runat="server" Visible="False" Width="41px"></asp:TextBox>
                </td>
             ...
             <tr>                    
                   <td colspan="4" class="ColumnTexto">
                        ...
                        <tr>
                            ...
                            <td class="ColumnLabels" ><div class="lbl">Dimensión:</div></td>
                            <td class="ColumnTexto">
                                <asp:TextBox ID="TxtDimension" runat="server" CssClass="nmBx" ReadOnly="True"></asp:TextBox>
                            </td>
                        </tr>
                        </table>
                   </td>
