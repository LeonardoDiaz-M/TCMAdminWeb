...
Public Class LiquidaInfraccionesTransito
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Try
            ...
            cxn1.Select_SQL(Me.grdresults, "exec CalculaInfraccionesTransito '" & Me.ddlDerechos.SelectedValue & "','" & Me.TxtDatoUno.Value.ToString & "','" & Me.TxtDatoDos.Value.ToString & "','" & Me.TxtNombre.Text & "','" & Me.TxtDireccion.Text & "','" & Me.TxtRFC.Text & "','" & Me.WDFechaInfraccion.Value.ToString & "'")
