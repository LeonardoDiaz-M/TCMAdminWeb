       ...
       <table class="BarraPago">
             <tr>
                            <td Class="btn btn-small btn-primary glyphicon glyphicon-print" >                                 
                                <asp:LinkButton ID="btnimprime" runat="server"  BackColor="Transparent" ForeColor="White" OnClientClick="window.document.forms[0].target='_blank'" PostBackUrl="~/Reports/Report.aspx?Nombre=Reports/rpliquidaTraslado.rdlc" Height="100%" Width="100%">Imprimir</asp:LinkButton>
                             </td>           
                            <td>&nbsp;</td>
