<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="LiquidaDerechos.aspx.vb" Inherits="WebTCMAdmin.LiquidaDerechos" %>
            ...
            <tr>
             ...
             <tr>
                   ...
                   <td class="ColumnLabels" style="text-align:left;">
                       <asp:Label ID="lblDatoUno" runat="server" Visible="True" CssClass="lbl" Text="123aaasaaa"></asp:Label>
                       <ig:WebNumericEditor ID="TxtDatoUno" runat="server" Height="19px" MaxDecimalPlaces="2" MinDecimalPlaces="2" MinValue="0" Nullable="False" NullValue="0" Width="70px">
                       </ig:WebNumericEditor>
                       <asp:Label ID="lblDatoDos" runat="server" Visible="True" CssClass="lbl" Text="123aaasaaa"></asp:Label>
                       <ig:WebNumericEditor ID="TxtDatoDos" runat="server" Height="19px" MaxDecimalPlaces="2" MinDecimalPlaces="2" MinValue="0" Nullable="False" NullValue="0" Width="70px">
                       </ig:WebNumericEditor>
                   </td>
                 <td class="ColumnTexto">&nbsp;</td>
             </tr>    
