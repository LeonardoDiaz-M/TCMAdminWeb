<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="LiquidaPredial.aspx.vb" Inherits="WebTCMAdmin.LiquidaPredial" %>
               ...
               <td>
                 <asp:Panel ID="Panel1" runat="server" ScrollBars="Vertical" 
                    ...
                    <asp:GridView ID="grdresults" runat="server" CssClass="gridGral">
                        ...
                        <PagerStyle BorderColor="Silver" BorderStyle="Solid" ForeColor="#8C4510" HorizontalAlign="Center" />
