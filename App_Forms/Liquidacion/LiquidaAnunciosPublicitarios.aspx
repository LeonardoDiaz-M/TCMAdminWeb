<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="LiquidaAnunciosPublicitarios.aspx.vb" Inherits="WebTCMAdmin.LiquidaAnunciosPublicitarios" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <div class="Titulo">IMPUESTO SOBRE ANUNCIOS PUBLICITARIOS</div>    
    <hr />
    <div class="SubTitulo"> <strong>INFORMACIÓN REQUERIDA</strong></div>        
          <table class="tablarequerimientos">            
            ...
            <tr>
                ...
                <td style="text-align: left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<asp:CheckBox ID="chkTemporal" runat="server" AutoPostBack="True" Font-Bold="True" Text="Exhibición Temporal" />
                </td>
                <td style="text-align: left">
                    <asp:Label ID="lblDias" runat="server" Font-Bold="True" Text="Núm. de días:" Visible="False"></asp:Label>
                    <asp:TextBox ID="TxtNumDias" runat="server" Visible="False" Width="41px"></asp:TextBox>
                </td>
